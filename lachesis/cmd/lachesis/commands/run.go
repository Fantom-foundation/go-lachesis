...
import (
	...
	"github.com/Fantom-foundation/go-lachesis/lachesis/src/dummy"
	"github.com/Fantom-foundation/go-lachesis/lachesis/src/lachesis"
	"github.com/Fantom-foundation/go-lachesis/lachesis/src/log"
	aproxy "github.com/Fantom-foundation/go-lachesis/lachesis/src/proxy"
	"github.com/Fantom-foundation/go-lachesis/lachesis/tester"
	...
	if config.Lachesis.Test {
		...
		go func() {
			for {
				...
				if ct >= 1 /*3*10*config.Lachesis.TestN*/ && pdl < 1 {
