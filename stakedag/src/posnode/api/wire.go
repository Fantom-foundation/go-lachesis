...
//go:generate mockgen -package=api -self_package=github.com/Fantom-foundation/go-lachesis/stakedag/src/posnode/api -destination=mock_service.go github.com/Fantom-foundation/go-lachesis/stakedag/src/posnode/api NodeServer
