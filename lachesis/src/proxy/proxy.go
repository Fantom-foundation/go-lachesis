...
//go:generate mockgen -package=proxy -self_package=github.com/Fantom-foundation/go-lachesis/lachesis/src/proxy -destination=mock_test.go github.com/Fantom-foundation/go-lachesis/lachesis/src/proxy App,Node,Consensus
