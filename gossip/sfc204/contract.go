...
func (_Contract *ContractCaller) CalcValidatorLockupPenalty(opts *bind.CallOpts, stakerID *big.Int, withdrawalAmount *big.Int) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "calcValidatorLockupPenalty", stakerID, withdrawalAmount)
	return *ret0, err
}
...
//
// Solidity: function calcValidatorLockupPenalty(uint256 stakerID, uint256 withdrawalAmount) view returns(uint256)
func (_Contract *ContractSession) CalcValidatorLockupPenalty(stakerID *big.Int, withdrawalAmount *big.Int) (*big.Int, error) {
	return _Contract.Contract.CalcValidatorLockupPenalty(&_Contract.CallOpts, stakerID, withdrawalAmount)
}

// CalcValidatorLockupPenalty is a free data retrieval call binding the contract method 0xb23fd9c2.
//
// Solidity: function calcValidatorLockupPenalty(uint256 stakerID, uint256 withdrawalAmount) view returns(uint256)
func (_Contract *ContractCallerSession) CalcValidatorLockupPenalty(stakerID *big.Int, withdrawalAmount *big.Int) (*big.Int, error) {
	return _Contract.Contract.CalcValidatorLockupPenalty(&_Contract.CallOpts, stakerID, withdrawalAmount)
}
...
func (_Contract *ContractTransactor) UpdateStakeTokenizerAddress(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "_updateStakeTokenizerAddress", addr)
}
...
func (_Contract *ContractTransactor) CreateStake(opts *bind.TransactOpts, arg0 []byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "createStake", arg0)
}

// CreateStake is a paid mutator transaction binding the contract method 0xcc8c2120.
//
// Solidity: function createStake(bytes ) payable returns()
func (_Contract *ContractSession) CreateStake(arg0 []byte) (*types.Transaction, error) {
	return _Contract.Contract.CreateStake(&_Contract.TransactOpts, arg0)
}

// CreateStake is a paid mutator transaction binding the contract method 0xcc8c2120.
//
// Solidity: function createStake(bytes ) payable returns()
func (_Contract *ContractTransactorSession) CreateStake(arg0 []byte) (*types.Transaction, error) {
	return _Contract.Contract.CreateStake(&_Contract.TransactOpts, arg0)
}
