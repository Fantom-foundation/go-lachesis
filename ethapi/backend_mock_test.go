...
func (m *MockBackend) SendTx(ctx context.Context, signedTx *types.Transaction, trusted bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendTx", ctx, signedTx, trusted)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendTx indicates an expected call of SendTx
func (mr *MockBackendMockRecorder) SendTx(ctx, signedTx, trusted interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendTx", reflect.TypeOf((*MockBackend)(nil).SendTx), ctx, signedTx, trusted)
}
...
func (m *MockBackend) GetConsensusTime(ctx context.Context, shortEventID string) (uint64, error) {
	m.ctrl.T.Helper()
...
// TtfReport mocks base method
func (m *MockBackend) TtfReport(ctx context.Context, untilBlock rpc.BlockNumber, maxBlocks idx.Block, mode string) (map[hash.Event]time.Duration, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TtfReport", ctx, untilBlock, maxBlocks, mode)
	ret0, _ := ret[0].(map[hash.Event]time.Duration)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TtfReport indicates an expected call of TtfReport
func (mr *MockBackendMockRecorder) TtfReport(ctx, untilBlock, maxBlocks, mode interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TtfReport", reflect.TypeOf((*MockBackend)(nil).TtfReport), ctx, untilBlock, maxBlocks, mode)
}

// ForEachEvent mocks base method
func (m *MockBackend) ForEachEvent(ctx context.Context, epoch rpc.BlockNumber, onEvent func(*inter.Event) bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ForEachEvent", ctx, epoch, onEvent)
	ret0, _ := ret[0].(error)
	return ret0
}

// ForEachEvent indicates an expected call of ForEachEvent
func (mr *MockBackendMockRecorder) ForEachEvent(ctx, epoch, onEvent interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ForEachEvent", reflect.TypeOf((*MockBackend)(nil).ForEachEvent), ctx, epoch, onEvent)
}
...
func (m *MockBackend) GetValidationScore(ctx context.Context, stakerID idx.StakerID, epoch rpc.BlockNumber) (*big.Int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetValidationScore", ctx, stakerID, epoch)
	ret0, _ := ret[0].(*big.Int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBackendMockRecorder) GetValidationScore(ctx, stakerID, epoch interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetValidationScore", reflect.TypeOf((*MockBackend)(nil).GetValidationScore), ctx, stakerID, epoch)
}
...
func (m *MockBackend) GetDowntime(ctx context.Context, stakerID idx.StakerID, epoch rpc.BlockNumber) (idx.Block, inter.Timestamp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDowntime", ctx, stakerID, epoch)
...
func (mr *MockBackendMockRecorder) GetDowntime(ctx, stakerID, epoch interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDowntime", reflect.TypeOf((*MockBackend)(nil).GetDowntime), ctx, stakerID, epoch)
}

// GetDelegatorClaimedRewards mocks base method
func (m *MockBackend) GetDelegatorClaimedRewards(ctx context.Context, addr common.Address) (*big.Int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDelegatorClaimedRewards", ctx, addr)
	ret0, _ := ret[0].(*big.Int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDelegatorClaimedRewards indicates an expected call of GetDelegatorClaimedRewards
func (mr *MockBackendMockRecorder) GetDelegatorClaimedRewards(ctx, addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDelegatorClaimedRewards", reflect.TypeOf((*MockBackend)(nil).GetDelegatorClaimedRewards), ctx, addr)
}
...
// GetStakerDelegatorsClaimedRewards mocks base method
func (m *MockBackend) GetStakerDelegatorsClaimedRewards(ctx context.Context, stakerID idx.StakerID) (*big.Int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStakerDelegatorsClaimedRewards", ctx, stakerID)
	ret0, _ := ret[0].(*big.Int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetStakerDelegatorsClaimedRewards indicates an expected call of GetStakerDelegatorsClaimedRewards
func (mr *MockBackendMockRecorder) GetStakerDelegatorsClaimedRewards(ctx, stakerID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStakerDelegatorsClaimedRewards", reflect.TypeOf((*MockBackend)(nil).GetStakerDelegatorsClaimedRewards), ctx, stakerID)
}
...
// GetDelegatorsOf mocks base method
func (m *MockBackend) GetDelegatorsOf(ctx context.Context, stakerID idx.StakerID) ([]sfctype.SfcDelegatorAndAddr, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDelegatorsOf", ctx, stakerID)
	ret0, _ := ret[0].([]sfctype.SfcDelegatorAndAddr)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDelegatorsOf indicates an expected call of GetDelegatorsOf
func (mr *MockBackendMockRecorder) GetDelegatorsOf(ctx, stakerID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDelegatorsOf", reflect.TypeOf((*MockBackend)(nil).GetDelegatorsOf), ctx, stakerID)
}
...
// GetDelegator indicates an expected call of GetDelegator
func (mr *MockBackendMockRecorder) GetDelegator(ctx, addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDelegator", reflect.TypeOf((*MockBackend)(nil).GetDelegator), ctx, addr)
}
