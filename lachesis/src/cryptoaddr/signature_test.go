...
var (
	testmsg     = hash.HexToHash("ce0677bb30baa8cf067c88db9811f4333d131bf8bcf12fe7065d211dce971008")
	...
	testaddress = hash.HexToPeer("5ebcafc66e93c8d4404ab041e3bb1702780f9f49f224ce14674c75950fcb2567")
...
func TestVerifySignature(t *testing.T) {
	...
	if VerifySignature(hash.Peer{}, testmsg, sig) {
		t.Errorf("signature valid with no key")
	}
	if VerifySignature(testaddress, hash.Hash{}, sig) {
	...
	wrongaddr[10]++
	if VerifySignature(hash.BytesToPeer(wrongaddr), testmsg, sig) {
...
func TestVerifySignatureMalleable(t *testing.T) {
	...
	addr := hash.HexToPeer("0x03ca634cae0d49acb401d8a4c6b6fe8c55b70d115bf400769cc1400f3258cd3138")
	msg := hash.HexToHash("0xd301ce462d3e639518f482c7f03821fec1e602018630ce621e1e7851c12343a6")
