...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 eth:1.0 personal:1.0 rpc:1.0 txpool:1.0 web3:1.0"
	httpAPIs = "eth:1.0 rpc:1.0 web3:1.0"
)
...
func TestConsoleWelcome(t *testing.T) {
	...
	// TODO: clone (or PR) "github.com/Fantom-foundation/go-ethereum/console" to customize welcome message
	cli.Expect(`
