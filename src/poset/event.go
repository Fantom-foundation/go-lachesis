...
// NewInternalTransaction InternalTransaction constructor
...
// NewInternalTransactionJoin create peer add internal transaction
...
// NewInternalTransactionLeave create peer leave internal transaction
